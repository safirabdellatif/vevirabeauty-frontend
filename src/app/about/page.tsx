...
export const metadata: Metadata = {
  title: "معاييرنا الصيدلية | فيرا بيوتي",
  description: "فيرا بيوتي بيت عناية سعودي يطبّق معايير الصيدلية على اختيار التركيبات: ترخيص جودة مختارة، حلال، جرعات مفصّحة، وضمان 30 يومًا.",
};
      ...
      <div className="container-max max-w-3xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-brand-gray text-lg leading-relaxed">
            فيرا بيوتي بيت عناية سعودي يختار تركيبات حساسة بعقلية الصيدلي، لا التاجر — قطرات، بودرة، وأطقم تلامس أجزاء حساسة من جسمكِ، فلا مكان للتجربة العشوائية.
          </p>
        </div>
        ...
        <div className="bg-brand-mint rounded-3xl p-8 mb-12 border border-brand-teal/10">
          ...
          <p className="text-brand-gray leading-loose text-base mt-4">
            فبنينا فيرا بيوتي بنفس منطق الصيدلية المرخّصة: قائمة قصيرة من التركيبات المختارة، جرعات معلنة، توافق مع هيئة الغذاء والدواء، وضمان واضح. لا كتالوج طويل، ولا مبالغات تسويقية.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-12">
          {[
            { icon: BadgeCheck, title: "ترخيص جودة مختارة", body: "كل مكوّن مطابق لمواصفات هيئة الغذاء والدواء المغرب ومُفصّح بوضوح." },
