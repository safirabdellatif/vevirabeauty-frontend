        ...
        <div className="space-y-8 text-brand-gray leading-relaxed">
          <section>
            ...
            <ul className="space-y-2">
              <li>الدفع عند الاستلام متاح داخل المغرب.</li>
          ...
          <section>
            ...
            <p>
              الأسعار المعروضة بالدرهم المغربي (MAD). العروض سارية حسب ما هو محدد في الموقع. تحتفظ فيرا بيوتي بحق تعديل الأسعار والعروض دون إشعار مسبق.
            </p>
          </section>
