  ...
  return (
    <div className="flex flex-col gap-3">
      {offers.map((offer) => {
        ...
        const isPromo = offer.quantity > 1;
          ...
          <motion.button
            ...
            className={cn(
              ...
              isSelected
                ...
                : isPromo
                ? "border-brand-gold/40 bg-brand-gold/5 hover:border-brand-teal/50"
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                {saving > 0 && (
                  <div className="text-xs text-brand-success mt-0.5 font-bold">
                    وفّري {saving} درهم
                  </div>
                )}
              </div>
