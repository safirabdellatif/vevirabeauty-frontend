...
export const PRODUCTS: Record<ProductId, Product> = {
  ...
  hair_loss_spray: {
    ...
    nameAr: "رشاش ضد تساقط الشعر — علاج إعادة نمو الشعر",
    shortNameAr: "رشاش تساقط الشعر",
    heroHeadline: "وقف التساقط — أعد تنشيط بصيلات الشعر",
    heroSubheading:
      "فورمولا إكسترا قوية للرجال والنساء — يعيد تنشيط البصيلات، يقلّل التساقط، ويدعم نمو شعر أقوى مع الاستمرار.",
    painAngles: [
    ...
    benefits: [
      "فورمولا إكسترا قوية — للرجال والنساء",
      "يعيد تنشيط البصيلات الخاملة ويقلّل التساقط",
      "محلول موضعي بدون رائحة — امتصاص سريع",
      "سهل التطبيق بالرشّ مرتين يوميًا",
      "مناسب للرجال والنساء — كما على العبوة",
    ],
    features: [
      { title: "رشاش ضد التساقط", body: "يقلّل التساقط ويُعيد تنشيط البصيلات — لشعر أقوى وأكثف مع الاستمرار.", icon: "badge-check" },
    ...
    galleryImages: [
      { src: featureImagePaths("hair-loss-spray")[0], alt: "رشاش ضد تساقط الشعر — فورمولا قوية" },
    ...
    lifestyleImages: lifestyleImageEntries("hair-loss-spray", [
      "تساقط الشعر — في الحمام",
      "ضعف البصيلات — ترقّق واضح",
      "ترقّق الشعر — خط الأمامي",
      "تقوية الجذور — تدليك فروة الرأس",
    ]),
  },
  melasma_cream: {
    id: "melasma_cream",
    ...
    galleryImages: [
      { src: featureImagePaths("melasma-cream")[0], alt: "مكوّنات تفتيح طبيعية" },
      { src: featureImagePaths("melasma-cream")[1], alt: "لطيف على البشرة — قوام كريمي" },
      { src: featureImagePaths("melasma-cream")[2], alt: "روتين بسيط — صباح ومساء" },
    ],
    featureImages: featureImagePaths("melasma-cream"),
    lifestyleImages: lifestyleImageEntries("melasma-cream", [
      "كلف الوجه — بعد الشمس",
      "بقع الشمس — على الخدود",
      "عدم توحّد لون البشرة",
      "تفتيح البقع الداكنة — تطبيق يومي",
    ]),
  },
};
